-- =========================================================
-- FINAL FIX SCRIPT (CORRECTED SCHEMA)
-- =========================================================
...
-- 2. MANUALLY UNLOCK PHYSICS (Using ONLY valid columns)
WITH target_user AS (
    SELECT id
    FROM auth.users
...
INSERT INTO public.enrollments (user_id, target_id, item_type, access_type)
SELECT id,
    'physics',
    'subject',
    'lifetime'
